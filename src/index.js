...
import { charKeyHandle, keyHandlers } from './key-handlers-events.js'
import "./styles/style.css";

export { main, root, input, resultInput, allowedKeys }

const main = document.querySelector(`main`) //query for the main
